...
public class DSAlgoIntroTest extends TestBase {

	HomePage homePage;
	DataStructurePage dsPage;
	String expectedPageTitle, actualPageTitle;
	String dataStructureName = "Data Structures-Introduction";
	...
	@Description("Before class method to navigate to data structure page -> Data Structures-Introduction")
	public void setup() {
		driver = getDriver();
	...
	@Description("Test case method to verify if user is on data structure page -> Data Structures-Introduction")
	...
	@Test(dependsOnMethods = "VerifyIntroTopicsLinks", dataProvider = "GetPythonScripts")
