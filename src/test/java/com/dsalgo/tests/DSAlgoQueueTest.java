...
public class DSAlgoQueueTest extends TestBase {
	...
	String dataStructureName ="Queue";

	String browserName;

	@BeforeClass
	@Severity(SeverityLevel.BLOCKER)
	@Description("Before class method to navigate to data structure page -> Queue")
	public void setup() {
		driver = getDriver();
	...
	@Description("Test case method to verify if user is on data structure page -> Queue ")
	@Severity(SeverityLevel.NORMAL)
	public void VerifyQueuePageTitle() {
	...
	@Test(dependsOnMethods = "VerifyQueuePageTitle")
	@Description("Test case method to verify links for different topics")
	@Severity(SeverityLevel.CRITICAL)
	public void VerifyQueueTopicsLinks() {
	...
	@Test(dependsOnMethods = "VerifyQueueTopicsLinks", dataProvider = "GetPythonScripts")
