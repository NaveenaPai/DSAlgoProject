...
public class DSAlgoArrayTest extends TestBase {

	HomePage homePage;
	DataStructurePage dsPage;
	String expectedPageTitle, actualPageTitle;
	String dataStructureName = "Array";
	public WebDriver driver;
	String browserName;

	@BeforeClass
	@Severity(SeverityLevel.BLOCKER)
	@Description("Before class method to navigate to data structure page -> Array")
	public void setup() {
		driver = getDriver();
	...
	@Description("Test case method to verify if user is on data structure page -> Array")
	@Severity(SeverityLevel.NORMAL)
	public void VerifyArrayPageTitle() {
	...
	@Test(dependsOnMethods = "VerifyArrayPageTitle")
	@Description("Test case method to verify links for different topics")
	@Severity(SeverityLevel.CRITICAL)
	public void VerifyArrayTopicsLinks() {
	...
	@Test(dependsOnMethods = "VerifyArrayTopicsLinks", dataProvider = "GetPythonScripts")
