...
public class DSAlgoStackTest extends TestBase {

	HomePage homePage;
	DataStructurePage dsPage;
	String expectedPageTitle, actualPageTitle;
	String dataStructureName ="Stack";
	...
	@Description("Before class method to navigate to data structure page -> Stack")
	public void setup() {
		driver = getDriver();
	...
	@Description("Test case method to verify if user is on data structure page -> Stack")
	@Severity(SeverityLevel.NORMAL)
	public void VerifyStackPageTitle() {
	...
	@Test(dependsOnMethods = "VerifyStackPageTitle")
	@Description("Test case method to verify links for different topics")
	@Severity(SeverityLevel.CRITICAL)
	public void VerifyStackTopicsLinks() {
	...
	@Test(dependsOnMethods = "VerifyStackTopicsLinks", dataProvider = "GetPythonScripts")
